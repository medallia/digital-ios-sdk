...
/// \param formPreloadTimestamp represents the epoch time in milliseconds when the specific from preload  has happened.
///
/// \param targetingEvaluationTimestamp represents the epoch time in milliseconds when the specific targeting evaluation has happened.
///
/// \param engagementId represents the engagement id as it appears in the digital command center under forms section.
///
/// \param engagementType MDEngagementType object that represent the engagement type.
///
/// \param payload MDCustomInterceptPayload object that contains the intercept payload.
///
- (void)targetEvaluationDidSuccessWithFormPreloadTimestamp:(double)formPreloadTimestamp targetingEvaluationTimestamp:(double)targetingEvaluationTimestamp engagementId:(NSString * _Nonnull)engagementId engagementType:(enum MDEngagementType)engagementType payload:(MDCustomInterceptPayload * _Nonnull)payload;
@end
...
/// \param timestamp represents the epoch time in milliseconds when the specific event has happened.
///
/// \param feedbackUUID represents the feedback UUID as it appears in the command center under inbox section, it is the id of the form submitted by user.
///
/// \param payload a string that contains the submitted feedback components (currently not text and image components) and the user’s feedback UUID, it is in json format.
///
- (void)feedbackDidSubmitWithTimestamp:(double)timestamp feedbackUUID:(NSString * _Nonnull)feedbackUUID payload:(NSDictionary<NSString *, id> * _Nonnull)payload;
@end


/// A delegate for receiving submitted form payload. This API method allows listening to in-form feedback content submitted by user.
SWIFT_PROTOCOL("_TtP18MedalliaDigitalSDK20MDFeedbackV2Delegate_")
@protocol MDFeedbackV2Delegate
@optional
/// The event is triggered when feedback was collected by SDK after “Submit” button was selected.
/// \param timestamp represents the epoch time in milliseconds when the specific event has happened.
///
/// \param feedbackClientCorrelationId represents the feedback UUID as it appears in the command center under inbox section, it is the id of the form submitted by user.
///
/// \param payload a string that contains the submitted feedback components (currently not text and image components) and the user’s feedback UUID, it is in json format.
///
- (void)feedbackDidSubmitWithTimestamp:(double)timestamp feedbackClientCorrelationId:(NSString * _Nonnull)feedbackClientCorrelationId payload:(NSDictionary<NSString *, id> * _Nonnull)payload;
@end
...
/// \param timestamp represents the epoch time in milliseconds when the specific event has happened.
///
/// \param formId represents the form id as it appears in the digital command center under forms section.
///
/// \param formTriggerType MDFormTriggerType
///
- (void)formDidSubmitWithTimestamp:(double)timestamp formId:(NSString * _Nonnull)formId formTriggerType:(enum MDFormTriggerType)formTriggerType;
...
/// \param formTriggerType MDFormTriggerType
///
- (void)formDidDismissWithTimestamp:(double)timestamp formId:(NSString * _Nonnull)formId formTriggerType:(enum MDFormTriggerType)formTriggerType;
...
/// \param formTriggerType MDFormTriggerType
///
- (void)formDidCloseWithTimestamp:(double)timestamp formId:(NSString * _Nonnull)formId formTriggerType:(enum MDFormTriggerType)formTriggerType;
...
/// \param formTriggerType MDFormTriggerType
///
- (void)formDidDisplayWithTimestamp:(double)timestamp formId:(NSString * _Nonnull)formId formTriggerType:(enum MDFormTriggerType)formTriggerType SWIFT_DEPRECATED_MSG("This method is deprecate, please use formDidDisplayV2(timestamp, formId, formTriggerType, formLocaleSet, formLocaleDisplay)");
/// This event is triggered when a form is displayed via code form or invitation form.
/// \param timestamp represents the epoch time in milliseconds when the specific event has happened.
///
/// \param formId represents the form id as it appears in the digital command center under forms section.
...
/// \param formTriggerType MDFormTriggerType
///
/// \param formLocaleSet String?
///
/// \param formLocaleDisplay String?
///
- (void)formDidDisplayV2WithTimestamp:(double)timestamp formId:(NSString * _Nonnull)formId formTriggerType:(enum MDFormTriggerType)formTriggerType formLocaleSet:(NSString * _Nullable)formLocaleSet formLocaleDisplay:(NSString * _Nullable)formLocaleDisplay;
...
/// \param formTriggerType MDFormTriggerType
///
/// \param blockedUrl external url that has been blocked.
///
- (void)formDidBlockExternalUrlWithTimestamp:(double)timestamp formId:(NSString * _Nonnull)formId formTriggerType:(enum MDFormTriggerType)formTriggerType blockedUrl:(NSString * _Nonnull)blockedUrl;
...
/// \param formTriggerType MDFormTriggerType
///
/// \param url external url that has been selected.
///
/// \param isBlocked if the url above was blocked then it’s true, otherwise it’s false
///
- (void)formDidLinkSelectWithTimestamp:(double)timestamp formId:(NSString * _Nonnull)formId formTriggerType:(enum MDFormTriggerType)formTriggerType url:(NSString * _Nonnull)url isBlocked:(BOOL)isBlocked;
/// This event is triggered when the thank you prompt was displayed after the form was submitted
/// \param timestamp represents the epoch time in milliseconds when the specific event has happened.
///
/// \param engagementId represents the form id/ app rating id as it appears in the digital command center under forms section.
///
/// \param formTriggerType MDFormTriggerType
///
- (void)formDidThankYouPromptWithTimestamp:(double)timestamp engagementId:(NSString * _Nonnull)engagementId formTriggerType:(enum MDFormTriggerType)formTriggerType;
@end
...
/// \param timestamp represents the epoch time in milliseconds when the specific event has happened.
///
/// \param interceptId represents the engagement id as it appears in the digital command center under forms section
///
/// \param engagementType MDEngagementType
///
- (void)interceptDidDisplayWithTimestamp:(double)timestamp interceptId:(NSString * _Nonnull)interceptId engagementType:(enum MDEngagementType)engagementType;
...
/// \param engagementType MDEngagementType
///
- (void)interceptDidAcceptWithTimestamp:(double)timestamp interceptId:(NSString * _Nonnull)interceptId engagementType:(enum MDEngagementType)engagementType;
...
/// \param engagementType MDEngagementType
///
- (void)interceptDidDeclineWithTimestamp:(double)timestamp interceptId:(NSString * _Nonnull)interceptId engagementType:(enum MDEngagementType)engagementType;
...
/// \param engagementType MDEngagementType
///
- (void)interceptDidDeferWithTimestamp:(double)timestamp interceptId:(NSString * _Nonnull)interceptId engagementType:(enum MDEngagementType)engagementType;
/// This event is triggered when SKStoreReviewController was triggered by the SDK.
/// \param timestamp represents the epoch time in milliseconds when the specific event has happened.
///
/// \param interceptId represents the engagement id as it appears in the digital command center under forms section
///
- (void)interceptDidTriggerSKStoreReviewControllerWithTimestamp:(double)timestamp interceptId:(NSString * _Nonnull)interceptId;
@end


SWIFT_PROTOCOL("_TtP18MedalliaDigitalSDK21MDInterceptV3Delegate_")
@protocol MDInterceptV3Delegate
@optional
/// This event is triggered when intercept was displayed to end user.
/// \param timestamp represents the epoch time in milliseconds when the specific event has happened.
///
...
/// \param engagementType MDEngagementType
///
- (void)interceptDidDisplayWithTimestamp:(double)timestamp engagementId:(NSString * _Nonnull)engagementId engagementType:(enum MDEngagementType)engagementType;
/// This event is triggered when intercept was accepted by user from alert (usually “Provide Feedback”) or SDK banner.
/// \param timestamp represents the epoch time in milliseconds when the specific event has happened.
///
/// \param engagementId represents the engagement id as it appears in the digital command center under forms section
...
/// \param engagementType MDEngagementType
///
- (void)interceptDidAcceptWithTimestamp:(double)timestamp engagementId:(NSString * _Nonnull)engagementId engagementType:(enum MDEngagementType)engagementType;
/// This event is triggered when intercept was declined by user from alert (usually “No Thanks”) or SDK banner.
/// \param timestamp represents the epoch time in milliseconds when the specific event has happened.
///
/// \param engagementId represents the engagement id as it appears in the digital command center under forms section
...
/// \param engagementType MDEngagementType
///
- (void)interceptDidDeclineWithTimestamp:(double)timestamp engagementId:(NSString * _Nonnull)engagementId engagementType:(enum MDEngagementType)engagementType;
/// This event is triggered when intercept was deferred by user from alert (usually “Maybe Later”) or SDK banner.
/// \param timestamp represents the epoch time in milliseconds when the specific event has happened.
///
/// \param engagementId represents the engagement id as it appears in the digital command center under forms section
...
/// \param engagementType MDEngagementType
///
- (void)interceptDidDeferWithTimestamp:(double)timestamp engagementId:(NSString * _Nonnull)engagementId engagementType:(enum MDEngagementType)engagementType;
/// This event is triggered when SKStoreReviewController was triggered by the SDK.
/// \param timestamp represents the epoch time in milliseconds when the specific event has happened.
///
/// \param interceptId represents the engagement id as it appears in the digital command center under forms section
...
/// A deprecated delegate for receiving an invitation displayed information.
SWIFT_PROTOCOL("_TtP18MedalliaDigitalSDK20MDInvitationDelegate_")
@protocol MDInvitationDelegate
@optional
- (void)invitationDidDisplayWithTimestamp:(double)timestamp formId:(NSString * _Nonnull)formId;
- (void)invitationDidAcceptWithTimestamp:(double)timestamp formId:(NSString * _Nonnull)formId;
- (void)invitationDidDeclineWithTimestamp:(double)timestamp formId:(NSString * _Nonnull)formId;
- (void)invitationDidDeferWithTimestamp:(double)timestamp formId:(NSString * _Nonnull)formId;
@end
...
/// public static void setInvitationListener(MDInvitationListener invitationListener)
/// \param invitationDelegate MDInvitationDelegate
///
+ (void)setInvitationDelegate:(id <MDInvitationDelegate> _Nullable)invitationDelegate SWIFT_DEPRECATED_MSG("This method is deprecate, please use setInterceptDelegate(MDInterceptDelegate)");
...
///
+ (void)setInterceptDelegate:(id <MDInterceptDelegate> _Nullable)interceptDelegate SWIFT_DEPRECATED_MSG("This method is deprecate, please use setInterceptV3Delegate(MDInterceptV3Delegate)");
/// Setting a delegate in order to receive intercept information (Alert or Banner displayed asking the user whether he/she wants to open form/app rating/ any other engagement type object)
/// \param interceptV3Delegate MDInterceptV3Delegate
///
+ (void)setInterceptV3Delegate:(id <MDInterceptV3Delegate> _Nullable)interceptV3Delegate;
...
/// Setting a delegate in order to receive feedback payload. This API method allows listening to in-form feedback content submitted by user.
/// \param feedbackV2Delegate MDFeedbackV2Delegate
///
+ (void)setFeedbackV2Delegate:(id <MDFeedbackV2Delegate> _Nullable)feedbackV2Delegate;
